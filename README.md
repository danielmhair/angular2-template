...
- [x] Added Font-Awesome to Project (for icons mainly).
- [x] Add font-awesome icons to project
- [ ] Save this to a separate repo - angular2-simple-template
- [ ] Add NodeJS to Project
- [ ] Save NodeJS Repo - angular2-nodejs-template

### [Font Awesome Icons](http://fontawesome.io/icons/) at your disposal!
